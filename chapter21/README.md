...
ingress.networking.k8s.io/portal-ingress   nginx   k8sbible.local   192.168.49.2    80      88s
```

```shell
$ curl --resolve "k8sbible.local:80:$( minikube ip )" -i http://k8sbible.local/video

#Verificar los servicios a traves del nginx-ingress
$ kubectl port-forward svc/ingress-nginx-controller -n ingress-nginx 8080:80

$ curl http://k8sbible.local:8080
$ curl http://k8sbible.local:8080/video
$ curl http://k8sbible.local:8080/shopping
