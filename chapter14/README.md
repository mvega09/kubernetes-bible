...
```shell
#Instalacion para ubuntu 22.04
$ curl -LO https://get.helm.sh/helm-v4.0.4-linux-amd64.tar.gz
...
$ helm install wp-demo bitnami/wordpress --dry-run --debug # Inspeccionar primero qué manifiestos YAML de objetos de Kubernetes fueron producidos por Helm.
```
...
$ helm install my-wordpress bitnami/wordpress --version 28.1.0
```
...
# Para iniciar sesion en el panel de wordpress ingresas http://192.168.59.150:30509/wp-admin
```
...
#Al ejecutar este comando los PersistentVolumes y PersistentVolumeClaims, creados por el chart de Helm, no serán limpiados – necesitas limpiarlos manualmente.
```
